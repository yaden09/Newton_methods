...
{
    ui->setupUi(this);
    connect(ui->start,SIGNAL(clicked()),this,SLOT(metodo()));//connected button to variable
    connect(ui->clear,SIGNAL(clicked()),this,SLOT(borrar()));//connected button to variable
    connect(ui->exit,SIGNAL(clicked()),this,SLOT(close()));//connected button to variable
}
